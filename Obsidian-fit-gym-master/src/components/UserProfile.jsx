...
function UserProfile() {
  ...
  return (
    <div className='text-center mt-5'>
      ...
      {
        userEditSatus===false?<div className="card mt-5 bg-secondary rounded-5 p-3">
      ...
      <button className="btn btn-warning fw-bold" onClick={onUserProfileEdit}> <MdEditNote className="fs-3 me-3"/> Edit Profile</button>
      </div>
      </div>
      :
      <form className="mt-4 w-50 mx-auto " onSubmit={handleSubmit(onModifiedUserSave)}>
        ...
        <button className="btn btn-success"> <MdOutlineDataSaverOn className="me-3"/>Save</button>
      </form>
      }
